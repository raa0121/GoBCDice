...
func (e *Evaluator) evalCompoundingRoll(
	...
	if node.Left() == nil {
		return nil, fmt.Errorf("evalCompoundingRoll: num is nil")
	}

	if node.Right() == nil {
		return nil, fmt.Errorf("evalCompoundingRoll: sides is nil")
	}
	...
	if left == nil {
		return nil, fmt.Errorf("evalCompoundingRoll: evaluated num is nil")
	}
	...
	if right == nil {
		return nil, fmt.Errorf("evalCompoundingRoll: evaluated sides is nil")
	}
